                  ...
                  <div className="flex-1 p-4 md:p-6 bg-white overflow-hidden">
                    <div className="w-full max-w-2xl mx-auto space-y-4">
                       ...
                       <div className="h-16 md:h-20 bg-[#FFCA28] rounded-2xl flex items-center px-4 md:px-6 relative overflow-hidden shadow-sm">
                         ...
                         <div className="absolute right-4 md:right-6 px-2 md:px-3 py-1 bg-white/30 rounded-full text-[8px] md:text-[10px] font-bold">IDEA</div>
                       </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4">The ultimate productivity sanctuary.</h2>
            <p className="text-xl text-white/60">Features built deeply into the core experience.</p>
          </div>
